...
**Project**: audio-scraper-o-matic 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: build an app that accepts a youtube link and then scrapes the audio of from the youtube video and gives you an option to download it 
...
```sh
git clone https://github.com/GPT-Engineer-App/audio-scraper-o-matic.git
cd audio-scraper-o-matic
npm i
